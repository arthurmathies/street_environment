 ...
 * Return Type  : void
 */
void objectTracker_api(const mxArray *prhs[11], const mxArray *plhs[2])
{
  ...
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[8]), "x_measure", x_measure);
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[9]), "y_measure", y_measure);
