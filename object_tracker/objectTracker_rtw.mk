...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\objectTracker.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\Tobias\GOOGLE~1\Uni\Phoenix\OBJECT~1
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\objectTracker.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\codegen\lib\objectTracker;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=objectTracker -DHAVESTDIO -DUSE_RTMODEL
...
{$(START_DIR)\codegen\lib\objectTracker}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\objectTracker}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
